...
import Blogs from "./pages/MyProducts";
    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route
          path="/sell"
          element={
            user?.uid ? <AddEditProduct user={user} /> : <Navigate to="/" />
          }
        />
        <Route
          path="/update/:id"
          element={
            user?.uid ? (
              <AddEditProduct user={user} setActive={setActive} />
            ) : (
              <Navigate to="/" />
            )
          }
        ...
        <Route
          path="/myproducts"
          element={<MyProducts setActive={setActive} user={user} />}
        />
        <Route
          path="/tag/:tag"
          element={<TagProduct setActive={setActive} />}
        />
        <Route
